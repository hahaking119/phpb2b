...
CREATE TABLE `pb_companies` (
  ...
  `faxcode` varchar(8) NOT NULL default '',
  `faxzone` varchar(8) NOT NULL default '',
...
CREATE TABLE `pb_expoes` (
  `id` int(10) NOT NULL auto_increment,
  `expotype_id` smallint(3) NOT NULL,
  `name` varchar(100) NOT NULL default '',
  `description` text,
...
CREATE TABLE `pb_industryfields` (
  ...
  `type_id` enum('offer','company','product','fair','market','news','hr') NOT NULL,
  `keyword_ids` text,
...
CREATE TABLE `pb_industrymodels` (
  `industry_id` smallint(6) NOT NULL,
  `model_id` enum('offers','products','companies') NOT NULL,
...
CREATE TABLE `pb_jobs` (
  ...
  `content` text,
  `require_gender_id` tinyint(1) NOT NULL,
  `peoples` varchar(5) NOT NULL default '',
  `require_education_id` tinyint(1) NOT NULL,
  `require_age` varchar(10) NOT NULL default '',
  `salary_id` tinyint(1) NOT NULL,
  `worktype_id` tinyint(1) NOT NULL,
  `status` tinyint(1) NOT NULL default '0',
...
CREATE TABLE `pb_keywords` (
  ...
  `target_id` int(10) NOT NULL,
  `target_position` tinyint(1) NOT NULL,
...
CREATE TABLE `pb_membergroups` (
  `id` smallint(3) NOT NULL auto_increment,
  `membertype_id` tinyint(1) NOT NULL,
  `name` varchar(50) NOT NULL default '',
  `description` text,
  ...
  `allow_album` tinyint(1) NOT NULL,
  ...
  `exempt` tinyint(1) unsigned zerofill NOT NULL,
  `created` int(10) NOT NULL default '0',
  `modified` int(10) NOT NULL default '0',
  PRIMARY KEY  (`id`)
) TYPE=MyISAM;
...
CREATE TABLE `pb_members` (
  ...
  `membertype_id` smallint(3) NOT NULL,
...
CREATE TABLE `pb_messages` (
  ...
  `from_member_id` int(10) NOT NULL,
  `cache_from_username` varchar(25) NOT NULL default '',
  `to_member_id` int(10) NOT NULL,
...
CREATE TABLE `pb_ordergoods` (
  ...
  `order_id` smallint(6) unsigned zerofill NOT NULL,
...
CREATE TABLE `pb_personals` (
  ...
  `max_education` tinyint(1) NOT NULL,
  PRIMARY KEY  (`member_id`)
) TYPE=MyISAM;
...
CREATE TABLE `pb_services` (
  ...
  `title` varchar(25) NOT NULL default '',
  `content` text,
  `nick_name` varchar(25) NULL default '',

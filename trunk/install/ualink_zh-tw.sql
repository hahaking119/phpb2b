...
CREATE TABLE pb_announcementtypes (
  ...
  PRIMARY KEY  (`id`)
) TYPE=MyISAM COMMENT='公告類型' AUTO_INCREMENT=1 ;
...
CREATE TABLE eos_favorites (
  `id` int(10) NOT NULL auto_increment,
  `member_id` int(10) NOT NULL default '-1' COMMENT '會員編號',
...
(9, '建築、房地產', 0, 0, 0, 0, 0, 1, 0),
(10, '農業', 0, 0, 0, 0, 0, 1, 0),
(11, '冶金、礦產', 0, 0, 0, 0, 0, 1, 0),
...
(279, '顏料', 5, 0, 0, 0, 0, 0, 0),
(280, '香料、香精', 5, 0, 0, 0, 0, 0, 0),
(281, '化工設備', 5, 0, 0, 0, 0, 0, 0),
(282, '塑料生產加工設備', 5, 0, 0, 0, 0, 0, 0),
(283, '化工廢料', 5, 0, 0, 0, 0, 0, 0),
(284, '庫存化工品', 5, 0, 0, 0, 0, 0, 0),
(285, '化工產品加工', 5, 0, 0, 0, 0, 0, 0),
(286, '化工產品代理', 5, 0, 0, 0, 0, 0, 0),
...
(355, '電子電工產品制造設備', 8, 0, 0, 0, 0, 0, 0),
(356, '充電器', 8, 0, 0, 0, 0, 0, 0),
(357, '廣電、電信設備', 8, 0, 0, 0, 0, 0, 0),
(358, '電子電工產品加工', 8, 0, 0, 0, 0, 1, 0),
...
(621, '電腦產品制造設備', 17, 0, 0, 0, 0, 0, 0),
(622, '電腦袋', 17, 0, 0, 0, 0, 0, 0),
(623, '電腦產品加工', 17, 0, 0, 0, 0, 0, 0),
...
(701, '能源產品代理', 20, 0, 0, 0, 0, 1, 0),
(702, '電力', 20, 0, 0, 0, 0, 1, 0),
(703, '天然氣', 20, 0, 0, 0, 0, 0, 0),
(704, '能源產品加工', 20, 0, 0, 0, 0, 0, 0),
...
(719, '環保產品代理', 21, 0, 1, 0, 0, 1, 0),
(720, '環保產品加工', 21, 0, 0, 0, 0, 1, 0),
(721, '其他未分類', 21, 0, 0, 0, 0, 1, 0),
(722, '網絡通信產品', 22, 0, 0, 0, 0, 0, 0),
(723, '鋰電池、鎳氫電池', 22, 0, 0, 0, 0, 0, 0),
(724, '通訊產品配件部件', 22, 0, 0, 0, 0, 0, 0),
(725, '電話機、可視電話', 22, 0, 0, 0, 0, 0, 0),
(726, '移動電話', 22, 0, 0, 0, 0, 0, 0),
(727, '相關產品', 22, 0, 0, 0, 0, 0, 0),
...
(808, '庫存交通產品及用具', 25, 0, 0, 0, 0, 0, 0),
(809, '交通運輸產品加工', 25, 0, 0, 0, 0, 0, 0),
(810, '電動車和配件', 25, 0, 0, 0, 0, 0, 0),
(811, '自行車、三輪車及配件', 25, 0, 0, 0, 0, 0, 0),
(812, '廢氣處理設施', 25, 0, 0, 0, 0, 1, 0),
(813, '交通產品代理', 25, 0, 0, 0, 0, 1, 0),
...
(166, NULL, '寧德', 352201, NULL),
(167, NULL, '龍巖', 352601, NULL),
...
(184, NULL, '煙臺', 370601, NULL),
(185, NULL, '濰坊', 370701, NULL),
(186, NULL, '濟寧', 370801, NULL),
...
(275, NULL, '瀘州', 510501, NULL),
(276, NULL, '德陽', 510601, NULL),
(277, NULL, '綿陽', 510701, NULL),
(278, NULL, '遂寧', 510901, NULL),
...
(366, NULL, '伊寧', 654101, NULL),
(367, NULL, '臺北', 710001, NULL),
(368, NULL, '基隆', 710002, NULL),
(369, NULL, '臺南', 710020, NULL),
(370, NULL, '高雄', 710019, NULL),
(371, NULL, '臺中', 710008, NULL),
...
-- 
-- 導出表中的數據 `eos_newstypes`
-- 

INSERT INTO eos_newstypes VALUES 
(1, '行業聚焦', 1, 0, 1, 0, 1248601001),
(2, '熱點專題', 1, 0, 1, 0, 1248601001),
(3, '焦點關註', 1, 0, 1, 0, 1248601053),
(4, '成功案例', 1, 0, 1, 0, 1248601053),
(5, '業界資訊', 1, 0, 1, 0, 1248601081),
(6, '國際資訊', 1, 0, 1, 0, 1248601081),
(7, '商業寶典', 1, 0, 1, 0, 1248601108),
(8, '外貿專題', 1, 0, 1, 0, 1248601108);

INSERT INTO eos_accesses VALUES ('1', '普通權限', '1', '3', '3', '3', '3', '3', '3', '3', '1', '1', '1', '1', '1', '1', '0', '3', '0', '0', '3', '2', '0');

##插入默認的公司類型

INSERT INTO eos_companytypes (name,avaliable,picture) VALUES ('供應商', 1,''),('采購商', 1,''),('生產商', 1,''),('加盟商', 1,''),('其他類型', 1,'');
...
(5, 'total', 'product', '產品總數', 0, NULL, NULL),
(6, 'total', 'product_today', '今日新增產品', 0, NULL, NULL),
...
(11, 'total', 'news', '資訊總數', 0, NULL, NULL);
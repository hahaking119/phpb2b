...
document.write('<li><img src="plugins/okqq/images/msn.gif" width="18" height="17" border="0" alt="MSN" /> <a href="msnim:chat?contact=MSN帐号">MSN咨询</a></li>');
...
document.write("<div id='divMenu' onmouseover='OnlineOver();'><img src='plugins/okqq/images/qq_1.gif' class='press' alt='在线咨询'></div>");
